...
domain: 40
id: "NIXH-40-VEC-001"
title: "Vector Log Pipeline — Architecture Decision"
type: adr
status: draft
complexity: 1
reviewed: 2026-05-21
...
path: "root/adr/ADR-44-vector.md"
links:
...
# "NIXH-40-VEC-001" — "Vector Log Pipeline"
...
"Vector Log Pipeline module." This module integrates with the SSoT configs registry for identity and network settings,
