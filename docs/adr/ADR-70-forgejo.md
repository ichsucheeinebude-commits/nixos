...
domain: 70
id: "NIXH-70-FRG-001"
title: "Forgejo Git — Architecture Decision"
type: adr
status: draft
complexity: 1
reviewed: 2026-05-21
...
path: "root/adr/ADR-70-forgejo.md"
links:
...
"Forgejo Git module." This module integrates with the SSoT configs registry for identity and network settings,
