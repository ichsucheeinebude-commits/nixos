...
domain: 70
id: "NIXH-70-SEM-001"
title: "Semaphore Ansible — Architecture Decision"
type: adr
status: draft
complexity: 1
reviewed: 2026-05-21
...
path: "root/adr/ADR-71-semaphore.md"
links:
...
# "NIXH-70-SEM-001" — "Semaphore Ansible"
...
"Semaphore Ansible module." This module integrates with the SSoT configs registry for identity and network settings,
...
### Positive
- Clean separation of concerns within the 70-forge domain
