...
domain: 70
id: "NIXH-70-CKP-001"
title: "Cockpit Web Admin — Architecture Decision"
type: adr
status: draft
complexity: 1
reviewed: 2026-05-21
...
path: "root/adr/ADR-72-cockpit.md"
links:
...
# "NIXH-70-CKP-001" — "Cockpit Web Admin"
...
"Cockpit Web Admin module." This module integrates with the SSoT configs registry for identity and network settings,
