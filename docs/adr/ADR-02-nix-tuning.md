...
domain: 00
id: "NIXH-00-COR-003"
title: "Nix Tuning — Architecture Decision"
type: adr
status: draft
complexity: 1
reviewed: 2026-05-21
...
path: "root/adr/ADR-02-nix-tuning.md"
links:
...
"Nix daemon tuning, GC settings, and build optimization." This module integrates with the SSoT configs registry for identity and network settings,
