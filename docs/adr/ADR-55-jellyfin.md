...
domain: 50
id: "NIXH-50-JEL-001"
title: "Jellyfin Media Server — Architecture Decision"
type: adr
status: draft
complexity: 1
reviewed: 2026-05-21
...
path: "root/adr/ADR-55-jellyfin.md"
links:
...
# "NIXH-50-JEL-001" — "Jellyfin Media Server"
...
"Jellyfin Media Server module." This module integrates with the SSoT configs registry for identity and network settings,
