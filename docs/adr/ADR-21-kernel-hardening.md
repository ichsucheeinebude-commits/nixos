...
domain: 20
id: "NIXH-20-KHD-001"
title: "Kernel Hardening — Architecture Decision"
type: adr
status: draft
complexity: 1
reviewed: 2026-05-21
...
path: "root/adr/ADR-21-kernel-hardening.md"
links:
...
# "NIXH-20-KHD-001" — "Kernel Hardening"
...
"Kernel Hardening module." This module integrates with the SSoT configs registry for identity and network settings,
