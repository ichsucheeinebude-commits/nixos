...
domain: 30
id: "NIXH-30-STR-001"
title: "Storage Pool (MergerFS) — Architecture Decision"
type: adr
status: draft
complexity: 1
reviewed: 2026-05-21
...
path: "root/adr/ADR-30-storage.md"
links:
...
# "NIXH-30-STR-001" — "Storage Pool (MergerFS)"
...
"Storage Pool (MergerFS) module." This module integrates with the SSoT configs registry for identity and network settings,
