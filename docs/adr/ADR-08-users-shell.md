...
domain: 00
id: "NIXH-00-COR-009"
title: "Users & Groups — Architecture Decision"
type: adr
status: draft
complexity: 1
reviewed: 2026-05-21
...
path: "root/adr/ADR-08-users-shell.md"
links:
...
"System user and group definitions (no shell aliases)." This module integrates with the SSoT configs registry for identity and network settings,
