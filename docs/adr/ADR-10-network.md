...
domain: 10
id: "NIXH-10-NET-001"
title: "Network Configuration — Architecture Decision"
type: adr
status: draft
complexity: 1
reviewed: 2026-05-21
...
path: "root/adr/ADR-10-network.md"
links:
...
# "NIXH-10-NET-001" — "Network Configuration"
...
"Base networking: systemd-resolved, DNS servers, host name." This module integrates with the SSoT configs registry for identity and network settings,
