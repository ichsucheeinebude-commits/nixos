...
path: "root/adr/ADR-09-postgresql.md"
links:
...
"PostgreSQL database service." This module integrates with the SSoT configs registry for identity and network settings,
