...
domain: 90
id: "NIXH-90-ARC-001"
title: "Architecture Rules — Architecture Decision"
type: adr
status: draft
complexity: 1
reviewed: 2026-05-21
...
path: "root/adr/ADR-91-architecture-rules.md"
links:
...
# "NIXH-90-ARC-001" — "Architecture Rules"
...
"Architecture Rules module." This module integrates with the SSoT configs registry for identity and network settings,
