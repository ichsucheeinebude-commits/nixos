...
domain: 90
id: "NIXH-92-DEF-001"
title: "Deferred Storage Operations — Architecture Decision"
type: adr
status: draft
complexity: 1
reviewed: 2026-05-21
...
path: "root/adr/ADR-92-deferred-ops.md"
links:
...
# NIXH-92-DEF-001 — Deferred Storage Operations
...
Deferred deletion operations for storage that respect HDD sleep cycles. This module integrates with the SSoT configs registry for identity and network settings,
...
### Positive
- Clean separation of concerns within the 90-policy domain
