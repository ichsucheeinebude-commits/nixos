...
domain: 10
id: "NIXH-10-PID-001"
title: "Pocket-ID OIDC — Architecture Decision"
type: adr
status: draft
complexity: 1
reviewed: 2026-05-21
...
path: "root/adr/ADR-17-pocket-id.md"
links:
...
# "NIXH-10-PID-001" — "Pocket-ID OIDC"
...
"Pocket-ID OIDC module." This module integrates with the SSoT configs registry for identity and network settings,
