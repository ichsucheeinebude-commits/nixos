...
complexity: 1
reviewed: 2026-05-21
tags: [hardware, cpu, gpu, sensors]
description: "Hardware detection, CPU microcode, GPU drivers, and sensor configuration."
...
Hardware detection, CPU microcode, GPU drivers, and sensor configuration.
