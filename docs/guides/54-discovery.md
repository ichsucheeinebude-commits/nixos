...
path: "root/guides/54-discovery.md"
links:
  adr: ADR-54-discovery.md
  guide: 54-discovery.md
...
This module provides "media discovery" functionality for the NixOS system.
"Media Discovery module."
...
my.services."media-discovery".enable = true;
```
...
systemctl status "media-discovery"

# Check config was applied
nixos-option my.services."media-discovery".enable

# Check logs
journalctl -u "media-discovery" -f --no-pager
```
...
- **Log location:** `journalctl -u "media-discovery" -f`
